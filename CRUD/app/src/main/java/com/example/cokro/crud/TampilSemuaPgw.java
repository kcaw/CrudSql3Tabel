...
public class TampilSemuaPgw extends AppCompatActivity implements ListView.OnItemClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        BtnBack = (Button)findViewById(R.id.KembaliPegawai);

        BtnTambah.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(TampilSemuaPgw.this, MainActivity.class);
        ...
        BtnBack.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(TampilSemuaPgw.this, HomeActivity.class);
                startActivity(intent);
            }
        });
    }
